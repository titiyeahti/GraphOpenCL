...
__kernel void blur33(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				...
				for(i = -(CONST_SIZE/2); i < (CONST_SIZE/2)+1; i++)
				{
...
__kernel void blurnn(__read_only image2d_t src,
		__write_only image2d_t dest, int n, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
				int i, j;
...
__kernel void gaussian33(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void gaussiannn(__read_only image2d_t src,
		__write_only image2d_t dest, int n, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void median33(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
				...
				write_imagef(dest, (int2) (id0, id1), array[CONST_SIZE2/2]);
};

__kernel void red(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void green(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void blue(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void grey(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void sobel(__read_only image2d_t src,
		__write_only image2d_t dest, sampler_t sampler)
{
...
__kernel void add(__read_only image2d_t src1, __read_only image2d_t src2,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void sub(__read_only image2d_t src1, __read_only image2d_t src2,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void and(__read_only image2d_t src1, __read_only image2d_t src2,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void or(__read_only image2d_t src1, __read_only image2d_t src2,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void xor(__read_only image2d_t src1, __read_only image2d_t src2,
		__write_only image2d_t dest, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void mult(__read_only image2d_t src, __write_only image2d_t dest,
		float val, sampler_t sampler)
{
				int id0 = get_global_id(0);
				int id1 = get_global_id(1);
...
__kernel void scale(__read_only image2d_t src, 
		__write_only image2d_t dest,sampler_t sampler)
{
				int2 id;
...
__kernel void hist(__read_only image2d_t src,
		__global int* histo, sampler_t sampler)
{
...
__kernel void convert(__global int* input, __global float* output,
